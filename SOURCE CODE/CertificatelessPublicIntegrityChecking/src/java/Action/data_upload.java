        ...
        try {
            ...
            if (status) {
                try {
                    ...
                    String query = "insert into data_files (uid, uname, enc_data, dkey, time, filekeyword, filename, data, block1, block2, block3, enc_time, hashcode, hashcode1, ori_block1, ori_block2, ori_block3, grp) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
